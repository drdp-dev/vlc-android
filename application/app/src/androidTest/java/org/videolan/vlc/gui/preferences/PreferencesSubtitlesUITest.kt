...
class PreferencesSubtitlesUITest: BasePreferenceUITest() {
    ...
    fun checkSubtitleSizeSetting() {
        ...
        checkModeChanged(key, "14", "16", MAP_SUBTITLE_SIZE)
        checkModeChanged(key, "10", "16", MAP_SUBTITLE_SIZE)
        checkModeChanged(key, "7", "16", MAP_SUBTITLE_SIZE)
    }
    ...
    companion object {
        val MAP_SUBTITLE_SIZE = mapOf("40" to R.string.subtitles_size_nano, "32" to R.string.subtitles_size_micro, "25" to R.string.subtitles_size_smallest, "19" to R.string.subtitles_size_small, "14" to R.string.subtitles_size_normal, "10" to R.string.subtitles_size_big, "7" to R.string.subtitles_size_huge)
